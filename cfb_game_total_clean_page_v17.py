"""CFB Game Total clean page V17 — Step 4 Matchup V3 fresh multi-source activation.

Additive over frozen V164 Page V15. Only the Step 4 presentation/data owner advances through a fresh module identity.
...
import cfb_game_total_step4_matchup_v3 as step4_owner

MODEL_VERSION = "CFB GAME TOTAL CLEAN PAGE V17 • V166 STEP4 FRESH MULTISOURCE"
MARKET = prior_v164.MARKET
FROZEN_PRESENTATION = "cfb_game_total_clean_page_v15"
SPORTSBOOK_PROJECTION_INFLUENCE = 0.0
MAY_MODIFY_PROJECTION = False
ACTIVE_MARKER = "CFB GAME TOTAL • V166 STEP4 FRESH MULTISOURCE ACTIVE"
...
def render_cfb_hub(market: str, section_header=None, status_info=None, team_logo=None, h=None) -> None:
    if market != MARKET:
        raise ValueError(f"V166 Game Total V17 page received unsupported market: {market}")
