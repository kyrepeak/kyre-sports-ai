...
additive NFL Game Totals V4 Step-4 pace-and-possession page while V4 preserves
the frozen V3 offense-vs-defense layer, V2 live-market layer, and V1 verified
slate foundation underneath. Moneyline continues through the fresh V9
matchup-card presentation while V9 delegates every analytical and eligibility
decision to the frozen V8 engine.
...
MODEL_VERSION = "NFL V1.8 • GAME TOTAL V4 STEP 4 PACE + POSSESSION • MONEYLINE V9 MATCHUP CARDS • V8 ENGINE FROZEN • SLATE V1 PRESERVED"
...
def render_nfl_hub(market: str = "Slate"):
    ...
    if market == "Game Total":
        from nfl_game_totals_hub_v4 import render_nfl_game_totals_hub
