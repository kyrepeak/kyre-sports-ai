"""KYRE Streamlit Router V119 — NFL Receiving Yards Step 8 FanDuel full lineup.

V119 is additive over certified Router V118. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V7 to V8.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v118 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V119 • NFL RECEIVING YARDS STEP 8 FANDUEL FULL LINEUP"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v118"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v8"
...
def _render_nfl_v119(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V119 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v119
