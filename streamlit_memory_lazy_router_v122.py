"""KYRE Streamlit Router V122 — NFL Passing Yards visual parity Step 2.

V122 is additive over frozen certified Router V121. It advances only exact
NFL -> Passing Yards to the isolated V29 visual-parity layer. Certified
Receiving Yards V10, Rushing Yards V15 and every other route remain delegated
to V121 unchanged.
"""
...
import streamlit_memory_lazy_router_v121 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V122 • NFL PASSING YARDS VISUAL PARITY STEP 2 QB HEROES"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v121"
NFL_SPORT_LABEL = "NFL"
PASSING_YARDS_MARKET = "Passing Yards"
ACTIVE_PASSING_YARDS_HUB = "nfl_passing_yards_hub_v29"
...
def _render_nfl_v122(market: str) -> None:
    market = str(market or "Slate")
    if market != PASSING_YARDS_MARKET:
        raise RuntimeError("Router V122 direct handler is Passing Yards only.")
...
def _render_direct_passing() -> None:
    ...
    root._render_nfl = _render_nfl_v122
