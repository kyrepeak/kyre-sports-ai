    ...
    *,
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # Enter the already-certified V154 fast route directly. Clicking the
            # sport selector first briefly renders default CFB Moneyline, whose
            # cfb_* memory purge can race with that legacy module graph before
            # the browser ever selects Over/Under. The exact query route is the
            # production route-restoration contract for CFB O/U.
