"""KYRE Streamlit Router V121 — NFL Receiving Yards Step 10 final page.

V121 is additive over certified Router V120. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V9 to V10.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v120 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V121 • NFL RECEIVING YARDS STEP 10 FINAL POLISH SPEED CERT"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v120"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v10"
...
def _render_nfl_v121(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V121 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v121
