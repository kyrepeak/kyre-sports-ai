"""KYRE Streamlit Router V76 — CFB O/U market-snapshot fast route.

Step 5 of the College Football Over/Under performance work.

V76 preserves Router V75's direct CFB Over/Under fast route and advances only
that route from Clean Page V34 to Clean Page V35. V35 keeps the certified
parallel analysis prewarm and activates freshness-safe Market Adapter V3
snapshot reuse. Every non-active-CFB-O/U route delegates to Router V75 unchanged.
"""
...
import streamlit_memory_lazy_router_v75 as prior
import streamlit_memory_lazy_router_v1 as root

MODEL_VERSION = "KYRE STREAMLIT ROUTER V76 • CFB O/U MARKET SNAPSHOT FAST ROUTE"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v75"
...
def _selectbox_v76(label: Any, options: Any, *args: Any, **kwargs: Any):
    if label == "🏟️ Sport":
...
def _render_direct_cfb_ou() -> None:
    ...
    root.st.selectbox = _selectbox_v76
