"""KYRE Streamlit Router V173 — CFB Game Total visual redesign Step 5.

Additive over Router V172. Only the normal College Football Game Total route
advances from Page V27 to Page V28. Frozen certification behavior remains
delegated through the prior certified route.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v172 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V173 • CFB GAME TOTAL VISUAL REDESIGN STEP 5 SYSTEM POLISH"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_VISUAL_REDESIGN_STEP5_SYSTEM_POLISH_ACTIVE"
)
FROZEN_ROUTER = "streamlit_memory_lazy_router_v172"
CFB_SPORT_LABEL = prior.CFB_SPORT_LABEL
GAME_TOTAL_MARKET = prior.GAME_TOTAL_MARKET
ACTIVE_PAGE = "cfb_game_total_clean_page_v28"
...
def _render_cfb_game_total_v173(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v172(market)
...
__all__ = [
    ...
    "_render_cfb_game_total_v173","_render_direct_cfb_game_total",
