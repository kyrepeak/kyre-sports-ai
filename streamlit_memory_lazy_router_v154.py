"""KYRE Streamlit Router V154 — CFB Over/Under compact evidence renderer.

Additive over frozen Router V153. V154 advances only exact College Football ->
Over/Under to Clean Page V39. Game Total remains owned by frozen V153; Moneyline
and every other certified route remain delegated through the existing chain.
"""
...
import streamlit_memory_lazy_router_v153 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V154 • CFB O/U COMPACT EVIDENCE RENDERER"
PRODUCTION_HEARTBEAT = "CFB_OVER_UNDER_V39_PRODUCTION_ACTIVE"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v153"
...
def _render_cfb_over_under_v154(market: str) -> None:
...
def _render_direct_cfb_over_under() -> None:
    ...
    root._render_nfl = _render_cfb_over_under_v154
