"""MLB Matchup Explorer V3.5 — Matchup Intelligence V2 Steps 1-2.

Presentation router for the redesigned single-player card. Step 2 adds the hitter
true-talent profile while the certified V1 model/ranking chain remains frozen.
"""
...
import mlb_matchup_player_v25 as player_layer
import mlb_matchup_rankings_v21 as rankings

VERSION = "MLB Matchup Hub V3.5 • Intelligence V2 Step 2"
...
_STEP2_CSS = r"""
<style>
.mxv2-step2{border-left:4px solid #b68cff}
...
def render_matchup_hub(games_df, section_header=None, status_info=None, team_logo=None, h=None):
    st.markdown(clean._CSS + step1_hub._EXTRA_CSS + _STEP2_CSS, unsafe_allow_html=True)
    st.caption("🧠 Matchup Intelligence V2 rebuild • Steps 1-2 active • V1 model frozen as rollback.")
