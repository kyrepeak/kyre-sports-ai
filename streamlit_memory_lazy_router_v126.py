"""KYRE Streamlit Router V126 — NFL Passing Yards visual parity Step 6 final.

V126 is additive over frozen Router V125. It advances only exact
NFL -> Passing Yards to V33 final visual parity. Receiving Yards,
Rushing Yards, and every other route remain delegated to V125 unchanged.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v125 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V126 • NFL PASSING YARDS VISUAL PARITY STEP 6 FINAL"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v125"
NFL_SPORT_LABEL = "NFL"
PASSING_YARDS_MARKET = "Passing Yards"
ACTIVE_PASSING_YARDS_HUB = "nfl_passing_yards_hub_v33"
...
def _render_nfl_v126(market: str) -> None:
    market = str(market or "Slate")
    if market != PASSING_YARDS_MARKET:
        raise RuntimeError("Router V126 direct handler is Passing Yards only.")
...
def _render_direct_passing() -> None:
    ...
    root._render_nfl = _render_nfl_v126
