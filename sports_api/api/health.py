...
# Register CFB + NFL market routes by extending the shared route table instead
# of nesting APIRouter lifespans. This preserves the certified Step17B shared-
# host lifespan and the Render startup-recursion fix from CFB Step 1.
