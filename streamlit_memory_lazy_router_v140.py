"""KYRE Streamlit Router V140 — Passing Yards presentation-grade route.

Additive over frozen Router V139. Advances only exact NFL -> Passing Yards to
V39 while preserving V38 Phoenix time and V37 smart-slate behavior. Every
other route delegates to V139 unchanged.
"""
...
import streamlit_memory_lazy_router_v139 as prior
from nfl_passing_yards_slate_controller_v1 import is_empty_slate_notice

MODEL_VERSION = "KYRE STREAMLIT ROUTER V140 • NFL PASSING YARDS PRESENTATION GRADES"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v139"
NFL_SPORT_LABEL = "NFL"
PASSING_YARDS_MARKET = "Passing Yards"
ACTIVE_PASSING_YARDS_HUB = "nfl_passing_yards_hub_v39"
...
def _render_nfl_v140(market: str) -> None:
    market = str(market or "Slate")
    if market != PASSING_YARDS_MARKET:
        raise RuntimeError("Router V140 direct handler is Passing Yards only.")
...
def _render_direct_passing() -> None:
    ...
    root._render_nfl = _render_nfl_v140
