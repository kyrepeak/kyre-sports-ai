...
# V31 is additive over the certified V30 shell. Keep the exact V30 browser
# contract phrases visible so the frozen DevSystem can prove the inherited
# protections while V31 adds the downstream identity-bridge marker.
_V31_MARKER = (
    "🟢 CFB O/U • CLEAN PAGE V31 ACTIVE • DOWNSTREAM IDENTITY BRIDGE ACTIVE • "
    "V30 BASE CONTRACT PRESERVED: CFB O/U • CLEAN PAGE V30 ACTIVE • "
