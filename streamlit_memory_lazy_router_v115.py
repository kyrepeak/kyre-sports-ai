"""KYRE Streamlit Router V115 — NFL Receiving Yards Page Step 4 volume + efficiency.

V115 is additive over certified Router V114. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V3 to V4.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v114 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V115 • NFL RECEIVING YARDS STEP 4 VOLUME + EFFICIENCY"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v114"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v4"
...
def _render_nfl_v115(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V115 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v115
