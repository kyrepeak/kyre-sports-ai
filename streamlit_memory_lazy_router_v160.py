"""KYRE Streamlit Router V160 — CFB Game Total V164 Render identity transport.

Additive over Router V159. V160 advances only exact College Football -> Game
Total to Page V15, preserving every non-target route through V159.
...
MODEL_VERSION = "KYRE STREAMLIT ROUTER V160 • CFB GAME TOTAL V164 RENDER IDENTITY"
