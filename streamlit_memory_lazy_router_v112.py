"""KYRE Streamlit Router V112 — NFL Receiving Yards Step 1 foundation.

V112 is additive over certified Router V111. It preserves every existing route,
including the frozen Passing Yards chain and Rushing Yards V15 fast path, while
activating only NFL -> Receiving Yards on the new isolated V1 foundation page.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v111 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V112 • NFL RECEIVING YARDS STEP 1 FOUNDATION"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v111"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v1"
...
def _render_nfl_v112(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V112 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v112
