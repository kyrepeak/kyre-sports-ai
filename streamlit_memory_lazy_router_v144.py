"""KYRE Streamlit Router V144 — Receiving Yards Matchup Tiers 2.0 route.

Additive over frozen Router V143. Advances only exact NFL -> Receiving Yards to
V13 while preserving smart slate, Phoenix time, Passing Yards V141, and every
...
import streamlit_memory_lazy_router_v143 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V144 • NFL RECEIVING YARDS MATCHUP TIERS 2.0"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v143"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v13"
...
def _render_nfl_v144(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V144 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v144
