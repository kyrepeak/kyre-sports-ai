"""KYRE Streamlit Router V143 — Receiving Yards Phoenix-time route.

Additive over frozen Router V142. Advances only exact NFL -> Receiving Yards to
V12 while preserving V11 smart-slate behavior and every other route unchanged.
"""
...
import streamlit_memory_lazy_router_v142 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V143 • NFL RECEIVING YARDS PHOENIX TIME"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v142"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v12"
...
def _render_nfl_v143(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V143 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v143
