"""KYRE Streamlit Router V123 — NFL Passing Yards visual parity Step 3.

V123 is additive over frozen Router V122. It advances only exact
NFL -> Passing Yards to V30 summary/profile visual parity. Receiving Yards,
Rushing Yards, and every other route remain delegated to V122 unchanged.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v122 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V123 • NFL PASSING YARDS VISUAL PARITY STEP 3 SUMMARY PROFILE"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v122"
NFL_SPORT_LABEL = "NFL"
PASSING_YARDS_MARKET = "Passing Yards"
ACTIVE_PASSING_YARDS_HUB = "nfl_passing_yards_hub_v30"
...
def _render_nfl_v123(market: str) -> None:
    market = str(market or "Slate")
    if market != PASSING_YARDS_MARKET:
        raise RuntimeError("Router V123 direct handler is Passing Yards only.")
...
def _render_direct_passing() -> None:
    ...
    root._render_nfl = _render_nfl_v123
