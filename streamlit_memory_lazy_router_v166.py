"""KYRE Streamlit Router V166 — CFB Game Total page cleanup Step 1.

Additive over Router V165. Only the normal College Football Game Total route
advances from Page V20 to Page V21. Step 6 certification remains delegated
through V165/V164 to Page V19 so the frozen production-certified surface stays untouched.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v165 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V166 • CFB GAME TOTAL PAGE CLEANUP STEP 2 PRESENTATION"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_PAGE_CLEANUP_STEP2_PRESENTATION_ACTIVE"
)
FROZEN_ROUTER = "streamlit_memory_lazy_router_v165"
CFB_SPORT_LABEL = prior.CFB_SPORT_LABEL
GAME_TOTAL_MARKET = prior.GAME_TOTAL_MARKET
ACTIVE_PAGE = "cfb_game_total_clean_page_v21"
...
def _render_step6_cert_surface() -> None:
    # Frozen V184/V185 production certification remains on Router V164/Page V19.
...
def _render_cfb_game_total_v166(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v164(market)
