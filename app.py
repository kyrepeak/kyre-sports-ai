"""Kyre Sports AI Streamlit entrypoint — NFL Passing Yards Step 6 live.

Router V86 is additive over certified Router V85. It preserves the College
Football Over/Under path and every existing sport/market route, while routing
only NFL -> Passing Yards to the game-environment page.

The Passing Yards page keeps projection, sportsbook grading, Monte Carlo,
probability, fair-line, EV, ranking, and recommendation logic OFF while Step 6
adds descriptive environment evidence with 0.0 projection influence.
...
STREAMLIT_MAIN_V86_NFL_PASSING_YARDS_STEP6_ENVIRONMENT_2026-09-11.
"""
...
DEPLOYMENT_HEARTBEAT = "STREAMLIT_MAIN_V86_NFL_PASSING_YARDS_STEP6_ENVIRONMENT_2026-09-11"
