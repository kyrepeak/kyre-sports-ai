...
its own WNBA-only guarded data layer with the V2.3.2 resilient-feed command center.
...
new_wnba_block = '''else:
    if market == "PRA":
        from wnba_pra_hub_v232 import render_wnba_pra_hub
...
source = source.replace(
    "V13 • UI 14.2</div>",
    "V13 • Hit UI V13.1 • WNBA PRA V2.3.2 • UI 14.2 • Slate V20.9.1 • ML V16.2 • Spread V15.4 • Totals V17.2 • Live V19.2 • Verified Future +30d</div>",
    1,
)
source = source.replace(
    "<b>KYRE SPORTS AI</b> • Model V13 • UI V14.2",
    "<b>KYRE SPORTS AI</b> • WNBA PRA V2.3.2 • Slate V20.9.1 • Hit V13 / UI V13.1 • Moneyline V16.2 • Spread V15.4 • Totals V17.2 • Live V19.2 • Verified Future Slates +30d • UI V14.2",
    1,
)
