"""Kyre Sports AI main entrypoint — WNBA PRA V2.8.2 + MLB Slate V3.2 + Matchup Explorer V2.4 + Hit UI V13.3 + HR V1.1 + H+R+RBI V1.0.1 + Pitcher K V1.0.6 + Moneyline V16.3 + Spread V15.5 + Totals V17.3 + Live V19.3.
"""
...
market_routes='''    elif market == "Live Game":
        ...
        from mlb_matchup_hub_v24 import render_matchup_hub
...
source=source.replace("Hit UI V13.1","Hit UI V13.3 • Matchup Explorer V2.4 • HR V1.1 • H+R+RBI V1.0.1 • Pitcher K V1.0.6")
...
source=source.replace("kyre_sports_ai_wnba_pra_v2_6_matchup_context_touch_nav.py","kyre_sports_ai_v2_4.py")
exec(compile(source,"kyre_sports_ai_v2_4.py","exec"),globals(),globals())
