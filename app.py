...
The production entrypoint now boots additive Router V157. V157 preserves the
certified router chain for every existing market while advancing only exact
College Football -> Game Total through a fresh production cache-bust module.
...
DEPLOYMENT_HEARTBEAT = "STREAMLIT_MAIN_V157_CFB_GAME_TOTAL_V161_CACHE_BUST_2026-09-17"
