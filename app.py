...
try:
    ...
    from streamlit_memory_lazy_router_v213 import record_bootstrap_import_ms, render_app\n    # Frozen Step 4 router compatibility: from streamlit_memory_lazy_router_v212 import record_bootstrap_import_ms, render_app
