"""Kyre Sports AI main entrypoint — WNBA PRA V2.8.2 + MLB Slate V3.2 + Matchup Explorer V2.7 + Daily Game Picks V1.9 + Hit UI V13.3 + HR V1.1 + H+R+RBI V1.0.1 + Pitcher K V1.0.7 + Moneyline V16.3 + Spread V15.5 + Totals V17.3 + Live V19.3.
"""
...
market_routes='''    elif market == "Live Game":
        ...
        from mlb_daily_game_picks_v19 import render_daily_game_picks
        from mlb_schedule_v32 import load_with_diagnostics
        import streamlit as st
...
source=source.replace("Hit UI V13.1","Hit UI V13.3 • Matchup Explorer V2.7 • Daily Game Picks V1.9 • HR V1.1 • H+R+RBI V1.0.1 • Pitcher K V1.0.7")
