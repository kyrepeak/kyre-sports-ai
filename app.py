...
now routed through V1.0.11 Steps 1-8: official MLB batter/team visual identity,
...
form/component-quality context, and opponent run-prevention/team-defense audit on
the strongest-probability cards. Every underlying H+R+RBI candidate, projection,
...
def _install_hrrbi_step8_route():
    """Route the frozen H+R+RBI V1.0.1 import to V1.0.11 Steps 1-8."""
    import mlb_hrrbi_hub_v111 as hrrbi_v111

    sys.modules["mlb_hrrbi_hub_v101"] = hrrbi_v111
...
exec(
    compile(
        source,
        "kyre_sports_ai_frozen_pre_nfl_plus_frozen_nfl_v18_pitcher_k_v1017_hrrbi_v111_step8_opponent_defense.py",
        "exec",
    ),
    globals(),
    globals(),
