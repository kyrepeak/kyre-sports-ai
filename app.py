'''Kyre Sports AI entrypoint — WNBA Assists Step 10 position-matchup routing layer.
...
navigation item opens the Step-10 page.

Assists V10 preserves Steps 1–9 and adds only Guard/Wing/Big assist matchup
context from the exact verified opponent's completed position-tagged WNBA box
scores. No pace, H2H, final assist projection, SportsGameOdds, market grading,
...
import wnba_assists_hub_v10 as wnba_assists_v10
...
exec(
    compile(
        source,
        "kyre_sports_ai_preserved_daily_picks_v10_plus_wnba_assists_v10_step10.py",
        "exec",
    ),
    globals(),
    globals(),
