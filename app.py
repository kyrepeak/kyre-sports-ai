...
Router V137 is additive over certified Router V136. It advances only exact
NFL -> Passing Yards to V36 compact-dashboard presentation while preserving the
certified V35/V34 transport/composition chain and frozen V33/V28 analytics.
NFL Spread remains owned by frozen V136; every other route remains delegated
through the certified router chain unchanged.
