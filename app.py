"""Kyre Sports AI main entrypoint — WNBA PRA V2.8.2 + MLB Slate V3.2 + Matchup Explorer V1.3 + Hit UI V13.3 + HR V1.1 + H+R+RBI V1.0.1 + Pitcher K V1.0.6 + Moneyline V16.3 + Spread V15.5 + Totals V17.3 + Live V19.3.
...
new MLB Matchup Explorer V1.3 as a game-first/player-first browsing layer with
full active-roster coverage and small-sample calibration, keeps MLB 1+ Hit on
V13.3, MLB Home Run on calibrated V1.1, MLB Hits + Runs + RBIs on joint-event
V1.0.1, MLB Pitcher Strikeouts on workload-first V1.0.6, MLB Moneyline on V16.3,
MLB Spread on V15.5, MLB Totals on V17.3, and MLB Live Game on V19.3.
"""
...
market_routes = '''    elif market == "Live Game":
        ...
        from mlb_matchup_hub_v13 import render_matchup_hub
...
source = source.replace("Hit UI V13.1", "Hit UI V13.3 • Matchup Explorer V1.3 • HR V1.1 • H+R+RBI V1.0.1 • Pitcher K V1.0.6")
...
source = source.replace(
    ...
    "kyre_sports_ai_wnba_pra_v2_8_2_mlb_slate_v3_2_matchup_explorer_v1_3_hit_v13_3_hr_v1_1_hrrbi_v1_0_1_pitcher_k_v1_0_6_ml_v16_3_spread_v15_5_totals_v17_3_live_v19_3.py",
)

exec(
    compile(source, "kyre_sports_ai_wnba_pra_v2_8_2_mlb_slate_v3_2_matchup_explorer_v1_3_hit_v13_3_hr_v1_1_hrrbi_v1_0_1_pitcher_k_v1_0_6_ml_v16_3_spread_v15_5_totals_v17_3_live_v19_3.py", "exec"),
    globals(),
    globals(),
)
