"""Kyre Sports AI — WNBA Live Games Step-4 routing wrapper.
...
replacement = "    import wnba_live_hub_v4 as wnba_live_v1"
if anchor not in source:
    raise RuntimeError("Frozen WNBA Live Step-1 route import not found.")
source = source.replace(anchor, replacement, 1)

compile(source, "<kyre_wnba_live_step4_preflight>", "exec")
exec(
    compile(source, "kyre_wnba_live_games_v4_step4.py", "exec"),
    globals(),
    globals(),
)
