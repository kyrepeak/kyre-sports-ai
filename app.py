...
V1.9.8.4.5, PRA V3.6.6, Spread V1.6.1, Moneyline V1.5 and Game Total V1.5.
PRA V3.6.6 preserves the full V3.6.2/V3.6.1 production model, the Step-9 Final
Top-5 identity presentation and the V3.6.5 V2.8 Minutes + Role Top-5 identity
reliability. It adds only cached opponent defensive context and a display-only
season points-allowed tier to the Step-5 cards. Projection, qualification, Monte
Carlo, ranking, final-ready gates and selection logic are unchanged.
...
import wnba_pra_hub_v366 as wnba_pra_v366
...
# Cache-safe PRA route with Step-5 identity + cached defense context + Final identity.
sys.modules["wnba_pra_hub_v321"] = wnba_pra_v366
...
exec(
    compile(
        source,
        "kyre_sports_ai_preserved_app_plus_mlb_hit_v1315_final_audit_freeze_daily_picks_v34_points_qualification_cache_repair_assists_v20_points_v19845_pra_v366_step5_defense_context_spread_v161_moneyline_v15_game_total_v15_runtime_nav.py",
        "exec",
    ),
    globals(),
    globals(),
