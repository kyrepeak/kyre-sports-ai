...
now routed through V1.0.10 Steps 1-7: official MLB batter/team visual identity,
...
plate-appearance/batting-order opportunity, and descriptive recent H+R+RBI
form/component-quality context on the strongest-probability cards. Every
...
def _install_hrrbi_step7_route():
    """Route the frozen H+R+RBI V1.0.1 import to V1.0.10 Steps 1-7."""
    import mlb_hrrbi_hub_v110 as hrrbi_v110

    sys.modules["mlb_hrrbi_hub_v101"] = hrrbi_v110
...
exec(
    compile(
        source,
        "kyre_sports_ai_frozen_pre_nfl_plus_frozen_nfl_v18_pitcher_k_v1017_hrrbi_v110_step7_recent_form.py",
        "exec",
    ),
    globals(),
    globals(),
