"""Kyre Sports AI main entrypoint — WNBA PRA V2.8.2 + MLB Slate V3.2 + Hit UI V13.3 + HR V1.0.1 + Moneyline V16.3 + Spread V15.5 + Totals V17.3 + Live V19.3.
...
V1.0.1, isolates MLB Moneyline through V16.3, isolates MLB Spread through V15.5,
isolates MLB Totals through V17.3, and isolates MLB Live Game through V19.3.
"""
...
# MLB Home Run ONLY: first isolated production route. All other MLB modules remain frozen.
# The menu already contains Home Run in the proven shell; replace only the placeholder branch path.
...
home_route = '''    elif market == "Live Game":
        ...
        from mlb_hr_hub_v101 import render_home_run_hub
        render_home_run_hub(games_df, section_header, status_info, team_logo, h)
    else:
'''
if home_marker not in source:
    raise RuntimeError("HR V1.0.1 bridge could not locate the MLB Live/placeholder boundary.")
...
source = source.replace("Hit UI V13.1", "Hit UI V13.3 • HR V1.0.1")
...
source = source.replace(
    ...
    "kyre_sports_ai_wnba_pra_v2_8_2_mlb_slate_v3_2_hit_v13_3_hr_v1_0_1_ml_v16_3_spread_v15_5_totals_v17_3_live_v19_3.py",
)

exec(
    compile(source, "kyre_sports_ai_wnba_pra_v2_8_2_mlb_slate_v3_2_hit_v13_3_hr_v1_0_1_ml_v16_3_spread_v15_5_totals_v17_3_live_v19_3.py", "exec"),
    globals(),
    globals(),
)
