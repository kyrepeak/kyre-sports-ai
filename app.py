"""Kyre Sports AI Streamlit entrypoint — NFL Receiving Yards smart slate.

Router V142 is additive over frozen Router V141. It advances only exact
NFL -> Receiving Yards to V11 while preserving the certified Passing Yards
V141 route and every other existing route unchanged.
...
DEPLOYMENT_HEARTBEAT = "STREAMLIT_MAIN_V142_NFL_RECEIVING_YARDS_SMART_SLATE_2026-09-16"
