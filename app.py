'''Kyre Sports AI entrypoint — MLB V2.1.7 frozen + WNBA PRA V3.2.1 frozen + Points V1.9.6 active.
...
team-logo fallback. V1.9.6 is presentation-only Step 2.2: richer Top Points cards
show existing season/L10/L5 form, minutes/usage, pace, opponent defense, position
matchup, H2H summary and expandable Why-this-pick explanations. These visual/data
context layers do not alter the Points projection or simulation.
...
V1.9.6 visual wrapper. MLB model math, PRA model math and frozen connectors
remain unchanged.
'''
...
import wnba_points_hub_v196 as wnba_points_v196
...
_NEW_WNBA_PLACEHOLDER = '''    elif market == "Points":
        from wnba_points_hub_v196 import render_wnba_points_hub
...
def _patch_inherited_app_text(value):
    ...
    if "wnba_points_hub_v196" not in text and _OLD_WNBA_PLACEHOLDER in text:
...
sys.modules["wnba_points_hub_v11"] = wnba_points_v196
sys.modules["wnba_points_hub_v12"] = wnba_points_v196
sys.modules["wnba_points_hub_v13"] = wnba_points_v196
sys.modules["wnba_points_hub_v14"] = wnba_points_v196
sys.modules["wnba_points_hub_v15"] = wnba_points_v196
sys.modules["wnba_points_hub_v151"] = wnba_points_v196
sys.modules["wnba_points_hub_v16"] = wnba_points_v196
sys.modules["wnba_points_hub_v17"] = wnba_points_v196
sys.modules["wnba_points_hub_v171"] = wnba_points_v196
sys.modules["wnba_points_hub_v18"] = wnba_points_v196
sys.modules["wnba_points_hub_v19"] = wnba_points_v196
sys.modules["wnba_points_hub_v191"] = wnba_points_v196
sys.modules["wnba_points_hub_v192"] = wnba_points_v196
sys.modules["wnba_points_hub_v193"] = wnba_points_v196
sys.modules["wnba_points_hub_v194"] = wnba_points_v196
sys.modules["wnba_points_hub_v195"] = wnba_points_v196
...
exec(
    compile(source, "kyre_sports_ai_mlb_v217_wnba_pra_v321_frozen_points_v196_enhanced_cards_step22.py", "exec"),
    globals(),
    globals(),
)
