'''Kyre Sports AI entrypoint — MLB V2.1.7 frozen + WNBA PRA V3.2.1 frozen + Points V1.8 active.
...
WNBA Points V1.8 uses the ET-reconciled WNBA schedule V2.5, strict current-roster
gate, corrected 8-team player/context handoff, explicit Points-date empirical
game logs, synchronized projection-sanity preflight and a Points-only rotation-
aware minutes allocator built from verified last-3/last-5 team box scores.
Sportsbook lines never drive minutes, projections or the sanity gate. PRA totals
...
WNBA Points routing. Legacy Points import names are pinned to the cache-safe V1.8
...
import wnba_points_hub_v18 as wnba_points_v18
...
_NEW_WNBA_PLACEHOLDER = '''    elif market == "Points":
        from wnba_points_hub_v18 import render_wnba_points_hub
...
def _patch_inherited_app_text(value):
    ...
    if "wnba_points_hub_v18" not in text and _OLD_WNBA_PLACEHOLDER in text:
...
sys.modules["wnba_points_hub_v11"] = wnba_points_v18
sys.modules["wnba_points_hub_v12"] = wnba_points_v18
sys.modules["wnba_points_hub_v13"] = wnba_points_v18
sys.modules["wnba_points_hub_v14"] = wnba_points_v18
sys.modules["wnba_points_hub_v15"] = wnba_points_v18
sys.modules["wnba_points_hub_v151"] = wnba_points_v18
sys.modules["wnba_points_hub_v16"] = wnba_points_v18
sys.modules["wnba_points_hub_v17"] = wnba_points_v18
sys.modules["wnba_points_hub_v171"] = wnba_points_v18
...
exec(
    compile(source, "kyre_sports_ai_mlb_v217_wnba_pra_v321_frozen_points_v18_rotation_minutes.py", "exec"),
    globals(),
    globals(),
)
