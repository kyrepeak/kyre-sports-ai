"""KYRE Streamlit Router V178 — CFB sport navigation Step 3 responsive polish.

Additive over Router V177. Preserves all Step 2 sport-navigation behavior and
activates Page V31 only for the exact CFB Game Total route.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v173 as page_owner
import streamlit_memory_lazy_router_v177 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V178 • CFB SPORT NAV STEP 3 RESPONSIVE POLISH"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_SPORT_NAV_STEP3_RESPONSIVE_POLISH_ACTIVE"
)
FROZEN_ROUTER = "streamlit_memory_lazy_router_v177"
CFB_SPORT_LABEL = prior.CFB_SPORT_LABEL
GAME_TOTAL_MARKET = prior.GAME_TOTAL_MARKET
ACTIVE_PAGE = "cfb_game_total_clean_page_v31"
...
SPORT_NAV_STEP3_ROUTER_MARKER = "CFB_GAME_TOTAL_SPORT_NAV_STEP3_RESPONSIVE_POLISH_ACTIVE"
...
def _render_cfb_game_total_v178(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v177(market)
...
__all__ = [
    ...
    "SPORTSBOOK_PROJECTION_INFLUENCE","SPORT_NAV_STEP3_ROUTER_MARKER",
    "STEP6_CERT_QUERY_KEY","STEP6_CERT_ROUTER_MARKER",
    "STEP6_VISUAL_PARITY_ROUTER_MARKER","_clear_game_total_route_query",
    ...
    "_purge_game_total_page_modules","_render_cfb_game_total_v178",
    "_render_direct_cfb_game_total","_render_exact_game_total_surface",
    "_render_step6_cert_surface","_restore_game_total_route_from_query",
    "_step6_cert_requested","_with_active_page","record_bootstrap_import_ms",
    "render_app",
]
