"""KYRE Streamlit Router V142 — Receiving Yards smart-slate route.

Additive over frozen Router V141. Advances only exact NFL -> Receiving Yards to
V11 while preserving the certified Passing Yards V141 route and every other
route unchanged.
"""
...
import streamlit_memory_lazy_router_v141 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V142 • NFL RECEIVING YARDS SMART SLATE"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v141"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v11"
...
def _render_nfl_v142(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V142 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v142
