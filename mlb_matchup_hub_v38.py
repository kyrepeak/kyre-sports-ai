"""MLB Matchup Explorer V4.2 — Matchup Intelligence V2 Steps 1-9."""
...
import mlb_matchup_player_v32 as player_layer
import mlb_matchup_rankings_v21 as rankings

VERSION = "MLB Matchup Hub V4.2 • Intelligence V2 Step 9"
...
_STEP9_CSS = r"""
<style>
.mxv2-step9{border-left:4px solid #f4c95d}
</style>
"""
...
def render_matchup_hub(games_df, section_header=None, status_info=None, team_logo=None, h=None):
    ...
    st.caption("🧠 Matchup Intelligence V2 rebuild • Steps 1-9 active • V1 model frozen as rollback.")
