...
to V7, which preserves verified Steps 1-4, the V5 projection + correlated
5,000,000-draw Monte Carlo, the V5.1 mobile run-control repair and V6
post-simulation qualification + strongest daily Top-5 selection, then adds
Step 7 final Points-style daily pick cards.
...
import wnba_ra_hub_v7 as presentation

MODEL_VERSION = "WNBA REBOUNDS + ASSISTS V7 • VIA HOT-RELOAD-SAFE V1 BOUNDARY"
