"""Streamlit lazy router V213 — Passing Yards Category Navigation Step 1.

Additive over frozen Router V212. Only active NFL Passing Yards advances from
frozen V61 to presentation-only V62 Category Navigation. Every unrelated route
delegates unchanged.
"""
...
MODEL_VERSION = "KYRE STREAMLIT ROUTER V213 • PASSING YARDS CATEGORY NAVIGATION STEP 1"
...
RUNTIME_MARKER = "PASSING_YARDS_V213_CATEGORY_NAV_STEP1_READY"
...
def render_app() -> None:
    ...
    st.markdown(
        '<span data-passing-yards-v213-runtime="category-navigation-step1" '
