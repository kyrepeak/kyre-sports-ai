"""KYRE Streamlit Router V29 — CFB official-scoreboard slate hotfix.
...
frozen Step-5 model receives the current NCAA date-scoped FBS scoreboard.
...
MODEL_VERSION = "KYRE STREAMLIT ROUTER V29 • CFB NCAA scoreboard hotfix"
