"""Streamlit lazy router V235 — Passing Yards speed Step 7 single-rerun."""
from __future__ import annotations

import importlib

import streamlit_memory_lazy_router_v234 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V235 • PASSING YARDS SPEED STEP 7 SINGLE RERUN"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v234"
PASSING_MARKET = "Passing Yards"
PASSING_HUB = "nfl_passing_yards_hub_v84"
FALLBACK_HUB = "nfl_passing_yards_hub_v83"
...
def _speed7_single_rerun_hub_importable(importer=importlib.import_module) -> bool:
...
def render_app() -> None:
    ...
    if not _speed7_single_rerun_hub_importable():
        return prior.render_app()
...
__all__ = [
    ...
    "_cold_passing_yards_query_requested","_speed7_single_rerun_hub_importable",
