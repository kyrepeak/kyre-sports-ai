"""KYRE Streamlit Router V120 — NFL Receiving Yards Step 9 matchup tiers.

V120 is additive over certified Router V119. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V8 to V9.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v119 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V120 • NFL RECEIVING YARDS STEP 9 MATCHUP TIERS"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v119"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v9"
...
def _render_nfl_v120(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V120 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v120
