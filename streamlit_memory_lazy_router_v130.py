"""KYRE Streamlit Router V130 — NFL Moneyline no-flash execution.

V130 is additive over frozen Router V129. It advances only exact
NFL -> Moneyline to V11. Passing Yards and every other route remain delegated
...
import streamlit_memory_lazy_router_v129 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V130 • NFL MONEYLINE NO-FLASH"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v129"
NFL_SPORT_LABEL = "NFL"
...
def _render_nfl_v130(market: str) -> None:
    market = str(market or "Slate")
    if market != MONEYLINE_MARKET:
        raise RuntimeError("Router V130 direct handler is Moneyline only.")
...
def _render_direct_moneyline() -> None:
    ...
    root._render_nfl = _render_nfl_v130
