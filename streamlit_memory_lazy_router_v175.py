"""KYRE Streamlit Router V175 — CFB Game Total page cleanup Step 2.

Additive over V174. V175 prevents stale CFB Game Total query parameters from
overriding an explicit user selection of another sport or another CFB market.
Intentional CFB Game Total deep links still restore normally.
"""
from __future__ import annotations

import streamlit as st

import streamlit_memory_lazy_router_v174 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V175 • CFB GAME TOTAL PAGE CLEANUP STEP 2 NAVIGATION ESCAPE"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_PAGE_CLEANUP_STEP2_NAVIGATION_ESCAPE_ACTIVE"
)
FROZEN_ROUTER = "streamlit_memory_lazy_router_v174"
...
PAGE_CLEANUP_STEP2_MARKER = "CFB_GAME_TOTAL_PAGE_CLEANUP_STEP2_NAVIGATION_ESCAPE_ACTIVE"
...
def _render_cfb_game_total_v175(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v174(market)
