"""MLB Matchup Explorer V2.4 — named Step 2 matchup score + fast/deep rankings."""
from __future__ import annotations

import streamlit as st

import mlb_matchup_player_v18 as player_layer
...
def render_matchup_hub(games_df, section_header=None, status_info=None, team_logo=None, h=None):
    ...
    st.caption(f"{VERSION} • named batter-vs-starter Step 2 • 0-100 pitch matchup score • sample reliability gates • fast/deep rankings preserved")
