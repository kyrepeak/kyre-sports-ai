"""KYRE Streamlit Router V117 — NFL Receiving Yards Step 6 projection recipe.

V117 is additive over certified Router V116. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V5 to V6.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v116 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V117 • NFL RECEIVING YARDS STEP 6 PROJECTION RECIPE"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v116"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v6"
...
def _render_nfl_v117(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V117 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v117
