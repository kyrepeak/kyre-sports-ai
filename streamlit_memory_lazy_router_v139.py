"""KYRE Streamlit Router V139 — Passing Yards Phoenix-time route.

Additive over frozen Router V138. Advances only exact NFL -> Passing Yards to
V38 while preserving V37 smart-slate behavior. Every other route delegates to
V138 unchanged.
"""
...
import streamlit_memory_lazy_router_v138 as prior
from nfl_passing_yards_slate_controller_v1 import is_empty_slate_notice

MODEL_VERSION = "KYRE STREAMLIT ROUTER V139 • NFL PASSING YARDS PHOENIX TIME"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v138"
NFL_SPORT_LABEL = "NFL"
PASSING_YARDS_MARKET = "Passing Yards"
ACTIVE_PASSING_YARDS_HUB = "nfl_passing_yards_hub_v38"
...
def _render_nfl_v139(market: str) -> None:
    market = str(market or "Slate")
    if market != PASSING_YARDS_MARKET:
        raise RuntimeError("Router V139 direct handler is Passing Yards only.")
...
def _render_direct_passing() -> None:
    ...
    root._render_nfl = _render_nfl_v139
