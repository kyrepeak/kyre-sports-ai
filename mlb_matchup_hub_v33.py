"""MLB Matchup Explorer V3.7 — Matchup Intelligence V2 Steps 1-4."""
...
import mlb_matchup_player_v27 as player_layer
import mlb_matchup_rankings_v21 as rankings

VERSION = "MLB Matchup Hub V3.7 • Intelligence V2 Step 4"
...
_STEP4_CSS = r"""
<style>
.mxv2-step4{border-left:4px solid #61d99b}
</style>
"""
...
def render_matchup_hub(games_df, section_header=None, status_info=None, team_logo=None, h=None):
    st.markdown(
        clean._CSS + step1_hub._EXTRA_CSS + step3_hub._STEP3_CSS + _STEP4_CSS,
        unsafe_allow_html=True,
    )
    st.caption("🧠 Matchup Intelligence V2 rebuild • Steps 1-4 active • V1 model frozen as rollback.")
