...
_QUERY_ENABLED_KEY = "mlb_step5_10b_canary"
_QUERY_PERCENT_KEY = "mlb_step5_10b_percent"
...
def resolve_streamlit_canary_config(
    ...
    *,
    ...
    """Resolve Step 5.10B control without mutating the certified Step 5.10 core."""
    ...
    if host_env_present:
        return {
            **base,
            ...
            "query_enabled_key": _QUERY_ENABLED_KEY,
            "query_percent_key": _QUERY_PERCENT_KEY,
    ...
    enabled = enabled_raw in _TRUE_VALUES if enabled_raw is not None else False
    try:
...
def streamlit_canary_rollout_config() -> dict[str, Any]:
    return resolve_streamlit_canary_config(
        ...
        query_enabled_value=_query_value(_QUERY_ENABLED_KEY),
        query_percent_value=_query_value(_QUERY_PERCENT_KEY),
    )
