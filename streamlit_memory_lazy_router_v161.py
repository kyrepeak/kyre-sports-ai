"""KYRE Streamlit Router V161 — CFB Game Total V165 Step 4 Matchup activation.

Additive over frozen Router V160. Only exact College Football -> Game Total
advances from Page V15 to Page V16. Every non-target route remains delegated to
V160. Projection math, probability/distribution math, model behavior, and
sportsbook projection influence remain unchanged.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v160 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V161 • CFB GAME TOTAL V165 STEP4 MATCHUP"
PRODUCTION_HEARTBEAT = "CFB_GAME_TOTAL_V165_STEP4_MATCHUP_ACTIVE"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v160"
CFB_SPORT_LABEL = prior.CFB_SPORT_LABEL
GAME_TOTAL_MARKET = prior.GAME_TOTAL_MARKET
ACTIVE_PAGE = "cfb_game_total_clean_page_v16"
...
def _render_cfb_game_total_v161(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v160(market)
