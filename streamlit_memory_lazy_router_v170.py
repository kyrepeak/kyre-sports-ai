"""KYRE Streamlit Router V170 — CFB Game Total visual redesign Step 2 hero.

Additive over Router V169. Only the normal College Football Game Total route
advances from Page V24 to Page V25. Frozen Step 6 certification continues to
delegate through the prior certified route.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v169 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V170 • CFB GAME TOTAL VISUAL REDESIGN STEP 2 MATCHUP HERO"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_VISUAL_REDESIGN_STEP2_MATCHUP_HERO_ACTIVE"
)
...
def _render_cfb_game_total_v170(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v169(market)
