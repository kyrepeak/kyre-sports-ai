"""KYRE Streamlit Router V179 — sport dropdown Step 2 UI.

Additive over Router V178. Preserves all frozen sport-card navigation behavior
and activates Page V32 only for the exact CFB Game Total route.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v173 as page_owner
import streamlit_memory_lazy_router_v178 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V179 • SPORT DROPDOWN STEP 2 UI"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_SPORT_DROPDOWN_STEP2_UI_ACTIVE"
)
FROZEN_ROUTER = "streamlit_memory_lazy_router_v178"
CFB_SPORT_LABEL = prior.CFB_SPORT_LABEL
GAME_TOTAL_MARKET = prior.GAME_TOTAL_MARKET
ACTIVE_PAGE = "cfb_game_total_clean_page_v32"
...
SPORT_DROPDOWN_STEP2_ROUTER_MARKER = "CFB_GAME_TOTAL_SPORT_DROPDOWN_STEP2_UI_ACTIVE"
...
def _render_cfb_game_total_v179(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v178(market)
...
__all__ = [
    ...
    "SPORTSBOOK_PROJECTION_INFLUENCE","SPORT_DROPDOWN_STEP2_ROUTER_MARKER",
    ...
    "_purge_game_total_page_modules","_render_cfb_game_total_v179",
