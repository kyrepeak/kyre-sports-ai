...
forwards that boundary to V1.9.8.4.10, which keeps the same Top-5 Step 2
Player-vs-Team History and Step 3 Minutes + Role + Usage cards and adds Step 4
Recent Scoring Form directly underneath them.
...
import wnba_points_hub_v198410 as presentation

# V1.9.8.4.10 exposes the genuine V1.9.8.4.5 production runtime object.
base = presentation.base

MODEL_VERSION = "WNBA POINTS V1.9.8.4.10 • STEP 4 VIA HOT-RELOAD-SAFE ROUTE"
