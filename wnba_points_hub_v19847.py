...
forwards that boundary to V1.9.8.4.11, which keeps the same Top-5 Step 2
Player-vs-Team History, Step 3 Minutes + Role + Usage and Step 4 Recent Scoring
Form cards, then adds Step 5 Opponent Defense + Positional Matchup directly
underneath them.
...
import wnba_points_hub_v198411 as presentation

# V1.9.8.4.11 exposes the genuine V1.9.8.4.5 production runtime object.
base = presentation.base

MODEL_VERSION = "WNBA POINTS V1.9.8.4.11 • STEP 5 VIA HOT-RELOAD-SAFE ROUTE"
