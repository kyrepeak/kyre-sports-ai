...
forwards that boundary to V1.9.8.4.17, which keeps the same Top-5 Step 2
...
Environment, and Step 7 Shot Volume + Scoring Efficiency with verified ESPN
WNBA box-score fallback plus explicit season/L10/L5 source-window sample sizes.
...
import wnba_points_hub_v198417 as presentation

# V1.9.8.4.17 exposes the genuine V1.9.8.4.5 production runtime object.
base = presentation.base

MODEL_VERSION = "WNBA POINTS V1.9.8.4.17 • STEP 7 SOURCE WINDOW LABEL REPAIR VIA HOT-RELOAD-SAFE ROUTE"
