"""KYRE Streamlit Router V113 — NFL Receiving Yards Page Step 2 player cards.

V113 is additive over certified Router V112. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V1 to V2.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v112 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V113 • NFL RECEIVING YARDS STEP 2 PLAYER CARDS"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v112"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v2"
...
def _render_nfl_v113(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V113 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v113
