"""KYRE Streamlit Router V124 — NFL Passing Yards visual parity Step 4.

V124 is additive over frozen Router V123. It advances only exact
NFL -> Passing Yards to V31 matchup/context visual parity. Receiving Yards,
Rushing Yards, and every other route remain delegated to V123 unchanged.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v123 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V124 • NFL PASSING YARDS VISUAL PARITY STEP 4 CONTEXT CARDS"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v123"
NFL_SPORT_LABEL = "NFL"
PASSING_YARDS_MARKET = "Passing Yards"
ACTIVE_PASSING_YARDS_HUB = "nfl_passing_yards_hub_v31"
...
def _render_nfl_v124(market: str) -> None:
    market = str(market or "Slate")
    if market != PASSING_YARDS_MARKET:
        raise RuntimeError("Router V124 direct handler is Passing Yards only.")
...
def _render_direct_passing() -> None:
    ...
    root._render_nfl = _render_nfl_v124
