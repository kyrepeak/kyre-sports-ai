"""KYRE Streamlit Router V118 — NFL Receiving Yards Step 7 support + concerns.

V118 is additive over certified Router V117. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V6 to V7.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v117 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V118 • NFL RECEIVING YARDS STEP 7 SUPPORT + CONCERNS"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v117"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v7"
...
def _render_nfl_v118(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V118 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v118
