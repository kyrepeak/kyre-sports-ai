"""WNBA PRA V3.6.4 — Step-5 headshot reliability wrapper.

Preserves PRA V3.6.2/V3.6.1 production behavior and the existing Step-9 Final
Top-5 identity presentation. Adds the V3.6.4 display-only Step-5 verified ESPN ID
fallback for players whose projection identity has no usable PLAYER_ID.
...
import wnba_pra_step5_identity_v364 as step5_identity

MODEL_VERSION = "PRA V3.6.4 • STEP-5 HEADSHOT RELIABILITY • MODEL PRESERVED"
...
def render_wnba_pra_hub(section_header=None, status_info=None, team_logo=None, h=None):
    ...
    st.caption(
        "🖼️ PRA UI V3.6.4 • Step-5 headshot reliability fallback ACTIVE • "
