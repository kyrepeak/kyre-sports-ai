...
def _fallback():
    away = {
        ...
        "third_down": _fallback_dim("64.3%", "44.8%"),
...
def test_v166_v3_loads_fallback_when_frozen_v15_passes_no_game(monkeypatch):
    calls = []
...
def test_v166_page_v17_activates_fresh_v3_over_frozen_v15():
...
def test_v166_router_v162_activates_only_exact_game_total():
...
def test_v166_app_runtime_boots_v162_and_preserves_v161_compatibility():
