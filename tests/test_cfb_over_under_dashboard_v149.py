...
def test_v36_is_presentation_only_over_certified_v35() -> None:
...
def test_v36_uses_phoenix_time_and_exact_logo_resolver() -> None:
...
def test_v36_keeps_model_flow_but_compacts_steps_5_through_10() -> None:
...
def test_v36_preserves_deep_evidence_and_full_slate_scan() -> None:
    source = inspect.getsource(page.render_over_under_hub)
