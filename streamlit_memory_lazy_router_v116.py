"""KYRE Streamlit Router V116 — NFL Receiving Yards Step 5 defense + H2H.

V116 is additive over certified Router V115. It preserves every existing route,
including frozen Passing Yards and certified Rushing Yards V15, while advancing
only NFL -> Receiving Yards from V4 to V5.
"""
from __future__ import annotations

import streamlit as st
import streamlit_memory_lazy_router_v1 as root
import streamlit_memory_lazy_router_v115 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V116 • NFL RECEIVING YARDS STEP 5 DEFENSE + H2H"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v115"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v5"
...
def _render_nfl_v116(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V116 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v116
