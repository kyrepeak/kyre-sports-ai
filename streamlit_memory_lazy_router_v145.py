"""KYRE Streamlit Router V145 — Receiving Yards player-card redesign route.

Additive over frozen Router V144. Advances only exact NFL -> Receiving Yards to
V14 while preserving smart slate, Phoenix time, Matchup Tiers 2.0, Passing Yards
V141, and every other route unchanged.
"""
...
import streamlit_memory_lazy_router_v144 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V145 • NFL RECEIVING YARDS PLAYER CARD REDESIGN"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v144"
NFL_SPORT_LABEL = "NFL"
RECEIVING_YARDS_MARKET = "Receiving Yards"
ACTIVE_RECEIVING_YARDS_HUB = "nfl_receiving_yards_hub_v14"
...
def _render_nfl_v145(market: str) -> None:
    market = str(market or "Slate")
    if market != RECEIVING_YARDS_MARKET:
        raise RuntimeError("Router V145 direct handler is Receiving Yards only.")
...
def _render_direct_receiving() -> None:
    ...
    root._render_nfl = _render_nfl_v145
