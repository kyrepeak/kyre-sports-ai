"""KYRE Streamlit Router V129 — NFL Moneyline fresh matchup cards.

V129 is additive over frozen Router V128. It advances only exact NFL ->
Moneyline to V9 matchup-first presentation. Passing Yards remains on certified
V128/V35 and every other route delegates to V128 unchanged.
"""
...
MODEL_VERSION = "KYRE STREAMLIT ROUTER V129 • NFL MONEYLINE FRESH MATCHUP CARDS"
FROZEN_ROUTER = "streamlit_memory_lazy_router_v128"
NFL_SPORT_LABEL = "NFL"
MONEYLINE_MARKET = "Moneyline"
ACTIVE_MONEYLINE_HUB = "nfl_moneyline_hub_v9"
...
def _render_nfl_v129(market: str) -> None:
    market = str(market or "Slate")
    if market != MONEYLINE_MARKET:
        raise RuntimeError("Router V129 direct handler is Moneyline only.")
...
def _render_direct_moneyline() -> None:
    ...
    root._render_nfl = _render_nfl_v129
