"""KYRE Streamlit Router V171 — CFB Game Total visual redesign Step 3.

Additive over Router V170. Only the normal College Football Game Total route
advances from Page V25 to Page V26. Frozen certification behavior remains
delegated through the prior certified route.
"""
from __future__ import annotations

import streamlit_memory_lazy_router_v170 as prior

MODEL_VERSION = "KYRE STREAMLIT ROUTER V171 • CFB GAME TOTAL VISUAL REDESIGN STEP 3 GAME TOTAL ANALYSIS"
PRODUCTION_HEARTBEAT = (
    f"{prior.PRODUCTION_HEARTBEAT} • "
    "CFB_GAME_TOTAL_VISUAL_REDESIGN_STEP3_GAME_TOTAL_ANALYSIS_ACTIVE"
)
FROZEN_ROUTER = "streamlit_memory_lazy_router_v170"
CFB_SPORT_LABEL = prior.CFB_SPORT_LABEL
GAME_TOTAL_MARKET = prior.GAME_TOTAL_MARKET
ACTIVE_PAGE = "cfb_game_total_clean_page_v26"
...
def _render_cfb_game_total_v171(market: str) -> None:
    if market != GAME_TOTAL_MARKET:
        return prior._render_cfb_game_total_v170(market)
...
__all__ = [
    ...
    "_render_cfb_game_total_v171","_render_direct_cfb_game_total",
