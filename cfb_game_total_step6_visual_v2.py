...
.gt185-s6-summarycopy{min-width:0}.gt185-s6-summarycopy b{display:block;color:#f9fbff;font-size:1.02rem;font-weight:950;letter-spacing:.035em}.gt185-s6-summarycopy b i{color:#4cecff;font-style:normal;text-shadow:0 0 12px rgba(76,236,255,.8)}.gt185-s6-legacytitle{color:#f9fbff;text-transform:uppercase}.gt185-s6-summarycopy span{display:block;color:#a8bbcf;font-size:.74rem;margin-top:3px}
